...
nyan.style.zIndex=-1
nyan.height=100px;let body=document.body
let html=document.documentElement
let height=Math.random()*Math.max(body.scrollHeight,body.offsetHeight,html.clientHeight,html.scrollHeight,html.offsetHeight);nyan.style.top=height
