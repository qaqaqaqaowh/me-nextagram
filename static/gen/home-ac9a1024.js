...
timeout=setTimeout(()=>{if(e.target.value){let xhr=new XMLHttpRequest()
...
resArray=data
for(let i=0;i<resArray.length;i++){res+=`<div class="result"><img src='${data[i].profile_image}'>${data[i].username}</div>`}
autocomplete.innerHTML=res
