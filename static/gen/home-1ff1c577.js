...
let height=Math.random()*Math.max(body.scrollHeight,body.offsetHeight,html.clientHeight,html.scrollHeight,html.offsetHeight);nyan.style.top=(height-190)+'px'
body.appendChild(nyan)
setTimeout(()=>{nyan.remove()},5000)}},1)